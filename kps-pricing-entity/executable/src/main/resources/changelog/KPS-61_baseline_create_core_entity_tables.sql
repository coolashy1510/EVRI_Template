...
-- TODO:nikita.shvinagir:2023-02-14: consider adding MxN relation between tournament and team. So far it is indirectly bound via
--  fixtures though we have the direct relation in the gap.
...
-- TODO:nikita.shvinagir:2023-02-14: consider adding MxN relation between tournament and participant. So far it is indirectly
--  bound via team_participant though a participant could be in tournament with no team. Also, team is considered to be optional in the lineup.
